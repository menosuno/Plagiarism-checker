...
#lemmatization
l_words1 = lemmetize(stemmed_words1)
l_words2 = lemmetize(stemmed_words2)
print(" ")
print(blue + ">>>>>>>>>>>>>>>>>AFTER LEMMATIZATION<<<<<<<<<<<<<<<<")
print(red + "#file1: ")
print(black + "")
print(l_words1)
print(" ")
...
#display similarity
result = similarity(l_words1, l_words2)
print(" ")
print(" ")
print(black + "-----------------------------------------------------------")
print(green + "Rate of plagiarism: ", result, "%")
print(black + "-----------------------------------------------------------")
